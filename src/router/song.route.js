...
song_lycpath
*/
router.post('/upload', authMiddleware.auth, authMiddleware.hadAdminPermission, songMiddleware.uploadValidator, songMiddleware.songValidator, songMiddleware.verifySong('post'), songController.upload)

// 2管理员登录 根据body参数 song_id 修改歌曲信息
router.put('/', authMiddleware.auth, authMiddleware.hadAdminPermission, songMiddleware.uploadValidator, songMiddleware.songValidator, songMiddleware.verifySong('put'), songController.updateSong)

// 3管理员登录 删除歌曲
router.delete('/:song_id', authMiddleware.auth, authMiddleware.hadAdminPermission, songMiddleware.verifySong('delete'), songController.deleteSong)
...
router.get('/:song_id', songMiddleware.verifySong('get'), songController.getSongById)
